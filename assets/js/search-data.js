...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/assets/pdf/Jung_Jae-Yu_MichiganStateUniversity_CV.pdf";
          },
        },{id: "nav-resume",
          title: "Resume",
          description: "",
          section: "Navigation",
          handler: () => {
            window.location.href = "/assets/pdf/Jung_Jae-Yu_MichiganStateUniversity_Resume.pdf";
          },
